  ...
  experience: [
    {
      ...
      bullets: [
        ...
        {
          md: '**병원 홈페이지 리뉴얼 SI(의사친구)를 PM 겸 프론트엔드로 진행 중.** 비개발자 고객과 정보구조·회원 정책을 직접 협상해 확정하고, AI 검색(GEO) 대응 구조 위에 AI 상담 챗봇과 운영 도구를 얹는 프로젝트. 인프라·인증 결정 5건을 고객이 판단할 수 있는 형태로 정리해 중개.',
