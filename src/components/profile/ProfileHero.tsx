          ...
          <motion.div
            ...
            <div className="space-y-4 mb-8">
              <p className="text-slate-600 dark:text-slate-300 leading-6">
                시각디자인을 전공하고 UI/UX 디자이너로 일하다, 직접 만들고
                싶어 프론트엔드 개발자로 전향했습니다. 디자이너 시절 쌓은 화면
                설계와 디자인 시스템에 대한 이해는, 지금 코드를 짤 때도 사용자
                입장에서 판단하게 해주는 저만의 강점입니다.
                <br />
                <br />
                현재는 AI 프로덕트 스타트업에서 기획(PM)과 프론트엔드 개발을
                함께 맡고 있습니다. 1년 가까이 방향을 잡지 못하던 신규 AI 챗봇
                서비스의 PM을 맡아, 3개월 만에 브랜딩과 서비스 목표를 확정하고
                MVP 개발·출시 준비까지 끌어냈습니다. 기획과 개발 사이에서 생기는
                간극을, 화면을 직접 구현해 메우는 일을 해왔습니다.
                <br />
                <br />
