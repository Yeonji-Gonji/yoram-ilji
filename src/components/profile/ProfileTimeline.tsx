...
const STAGES: Stage[] = [
  ...
  },
  {
    ...
    role: 'UI/UX·GUI 디자이너',
    detail:
      '커머스·패션뷰티 브랜드 웹·모바일을 기획·디자인했습니다(오뚜기몰·동원몰·V12·YOUANDUS·앤드백 등). 검색·장바구니·주문서 같은 화면을 상태(state)까지 설계하며, 화면 너머의 구조를 보는 눈을 길렀습니다.',
  },
  {
    period: '전향',
    role: '프론트엔드로 전환',
  ...
  },
  {
    ...
    detail:
      '1년 가까이 정체됐던 신규 AI 챗봇 서비스의 PM을 맡아 3개월 만에 출시 준비까지 끌어냈고, 임베드형 AI SDK의 배포 방식을 NPM에서 CDN으로 전환했습니다. 기획과 개발 사이의 병목을, 화면을 직접 구현할 수 있다는 점으로 메우는 일을 합니다.',
  },
];
