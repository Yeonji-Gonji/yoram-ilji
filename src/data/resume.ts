...
export const resume: ResumeData = {
  name: '김준희',
  title: '프론트엔드 개발자',
  tagline: '디자인 감각을 갖춘 프론트엔드 · 기획과 개발 사이를 직접 메우는 사람',
  contacts: [
  ...
  summaryLead:
    '시각디자인을 전공하고 유명 브랜드 커머스를 디자인하다 프론트엔드로 전향한 개발자입니다. 디자인 설계 경험은 사용자 관점에서 화면을 판단하는 기준이 되고, 직접 구현하는 능력은 기획과 개발 사이의 간극을 코드로 좁히는 무기가 됩니다. 현재 AI 프로덕트 스타트업에서 기획(PM)과 프론트엔드를 함께 맡아 여러 서비스를 운영 단계까지 책임지고 있습니다.',
  summaryPoints: [
    {
      md: '**커머스 도메인 감각** — 오뚜기몰·동원몰 등 브랜드 커머스를 검색·장바구니·주문서·회원 화면과 상태까지 설계(디자이너) → 결제·정산이 정확해야 하는 화면을 직접 구현(현재).',
    },
    {
      md: '**디자인 시스템 / 반응형 / 접근성** — 디자인 토큰·스타일가이드 제작 경험 + Tailwind·Emotion 기반 반응형 구현.',
    },
    {
      md: '**성능 / 운영 신뢰** — 번들·에셋 최적화, 배포 자동화, 실결제 장애 직접 수습 경험.',
    },
  ],
  experience: [
    {
      ...
      bullets: [
        {
          ...
          metric: '프론트 gzip 186KB · vitest 12 통과 · i18n 60키 ko/en · Cafe24 OpenAPI 27스펙 일치',
        },
        {
        ...
        },
        {
          ...
          metric: 'vitest 184케이스 통과 · 스프라이트 245KB→8.4KB · 초기 요청 2회→1회',
        },
        {
          md: 'AI 서비스 메인 웹을 **Next.js로 이관**하고 인증·결제·멤버십·캐스팅 동선을 구현해 정식 운영(LIVE). 한국어 하드코딩 24개 파일을 한/영으로 일괄 정리.',
        },
        {
  ...
  sideProjects: [
    ...
    {
      md: '**madi (마디)** | 단독, 진행 중 — 기획·개발 협의 휘발을 막는 Obsidian 플러그인. TypeScript, vitest 72개·CI·Claude API 연동.',
    },
    {
  ...
  skills: [
    { label: 'Frontend', items: 'React 19 · Next.js 16 · TypeScript · Angular · React Native · Vite' },
    { label: '상태/데이터', items: 'Zustand · Redux Toolkit · RxJS · TanStack Query · React Hook Form' },
    { label: '스타일', items: 'Tailwind CSS · Emotion · SCSS · 디자인 시스템' },
    { label: '그래픽/실시간', items: 'react-three-fiber·Three.js · WebSocket · D3.js · chart.js · Naver Map' },
    { label: '인프라/품질', items: 'GitHub Actions · AWS(S3·CloudFront) · Vercel · PWA · vitest · Playwright' },
    { label: '다국어', items: 'next-intl · react-i18next' },
    { label: '디자인', items: 'Photoshop·Illustrator · Figma · UI/UX · 서비스 플로우 기획' },
  ],
  education: [
